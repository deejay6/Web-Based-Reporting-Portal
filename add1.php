...
$gender=$_POST['gender'];
$sql="INSERT into user(name,userid,age,address,phone,email,password,gender)values('".$name."','".$userid."','".$age."','".$address."','".$phone."','".$email."','".$password."','".$gender."')";
$query=mysql_query($sql);
if(!$query)
echo"Failed"."<br>".mysql_error();
else
{?>
<h2 text align = "center"><?php echo"User Added Successfully"?></h2>
<?php
} 
?>
